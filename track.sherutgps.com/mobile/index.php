...
<body class="login-page" onload="connectLoad()">
		...
		<br>
         <div class="input-group">
		 <span class="input-group-addon" id="sizing-addon2"><i class="glyphicon glyphicon-play"></i></span>
		 <input id="company" type="text" class="form-control" placeholder="<? echo $la['COMPANY']; ?>" aria-describedby="sizing-addon2">
