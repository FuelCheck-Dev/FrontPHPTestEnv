						...
						<div class="row2">
							...
							<div class="width60">
								<select id="dialog_settings_event_type" class="select width100" onchange="settingsEventSwitchType();"/>
									...
									<option value="ecohaccel"><? echo $la['ECO_HARSH_ACCELERATION']; ?></option>
									<option value="ecoexthbra"><? echo $la['ECO_EXTREME_AND_HARSH_BRAKE']; ?></option>
									<option value="econbrake"><? echo $la['ECO_NORMAL_BRAKING']; ?></option>
